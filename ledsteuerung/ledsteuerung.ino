...
int blueledPin = D5;    // LED connected to digital pin 9
int greenledPin = D6;    // LED connected to digital pin 10
int redledPin = D7;    // LED connected to digital pin 11
/* Application*/
...
void callback(char* topic, byte* payload, unsigned int length) {
    ...
    msg[length] = '\0';
    Serial.println(msg);
    if(strcmp(topic,"home/adc480")==0){
      int adc=atoi(msg);
      int a= adc>>7;
      analogWrite(blueledPin, a);
    }
    if(strcmp(topic,"home/adc481")==0){
      int adc=atoi(msg);
      int a= adc>>7;
      analogWrite(greenledPin, a);
    }
    if(strcmp(topic,"home/adc482")==0){
      int adc=atoi(msg);
      int a= adc>>7;
...
void reconnect() {
    while (!client.connected()) {
        ...
        if (!client.connect("ESP8266ClientSub")) {
